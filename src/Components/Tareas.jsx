export const Tareas = ({tarea, setTarea}) => {
  return (
    <div className=" bg-white shadow-md px-5 py-10 rounded-lg mb-5">
      ...
      <p className="font-bold mb-3 text-gray-700 uppercase">
        Descripcion: <span className="font-normal normal-case">{tarea.descripcion}</span>
      </p>
      ...
      <div className="flex justify-between">
        ...
        >♻️ Actualizar</button>
        <button className="bg-violet-600 hover:bg-700 mt-4 rounded-md text-white p-1.5 font-bold" type="button">🗑️ Eliminar</button>
      </div>
    </div>
  );
};
